...
"""This Test case is to verify that whether the Basic functionality like reading and writing to an nvme device works successfully"""

device = '/dev/nvme0n1'
mount_point = '/mnt/nvme0'
file_path = os.path.join(mount_point, 'test_file05.txt')
